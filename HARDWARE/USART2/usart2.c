...
//ĞŞ¸ÄÈÕÆÚ:2016/8/18
//°æ±¾£ºV1.0
//¹Ù·½ÌÔ±¦µêµØÖ·£ºhttps://shop110330041.taobao.com
//°æÈ¨ËùÓĞ£¬µÁ°æ±Ø¾¿¡£
//All rights reserved
...
{ 	
	...
	{	 			   
		...
		TIM4_Set(0);			//¹Ø±ÕTIM4  
		UART3SendString(USART2_RX_BUF,USART2_RX_STA&0x7fff);	//Êä³öLOGĞÅÏ¢
		if(!USART2_RX_REC_ATCOMMAD)	
		{
			USART2_RX_BUF[USART2_RX_STA&0X7FFF]=0;//Ìí¼Ó½áÊø·û
			USART2_RX_STA=0;
			if(strstr((char*)USART2_RX_BUF,"RING")!=NULL)	Flag_Rec_Call=1;//¼ì²âÊÇ·ñÊÇÀ´µç»°ÁË
		}
